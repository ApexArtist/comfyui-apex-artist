...
- The existing GitHub workflow publishes to the registry when a push to main changes pyproject.toml; the 2.3.0 release push therefore publishes this version rather than acting as a backup.