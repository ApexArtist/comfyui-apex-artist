...
_FACE_PRESETS = {
    "Universal Beauty": {
        "prompt": "Delicate youthful feminine face with a compact, softly oval shape, balanced facial proportions with a slightly widened mid-face, gently rounded cheeks with soft full cheek volume, softly defined high cheekbones, a short lower face with a reduced vertical distance from the eyes to the chin, a measured forehead height that keeps the face compact, a smooth narrow jawline curving softly inward toward a small softly rounded chin, large almond-shaped eyes with gently lifted outer corners and a large eye-to-face ratio, softly arched natural eyebrows, small delicate straight nose with a narrow bridge and softly rounded petite tip, softly full lips with a naturally defined Cupid's bow and slightly fuller lower lip, smooth rounded facial contours, delicate feminine bone structure, harmonious compact proportions, fair porcelain skin with a subtle natural blush across the cheeks, realistic skin texture with visible pores and fine natural detail, naturally youthful appearance, serene gentle expression, anatomically realistic and natural.",
        "description": "Universal delicate beauty - compact softly oval structure with full youthful cheeks",
        "tags": ["universal", "delicate", "porcelain", "compact oval face", "almond eyes", "natural", "youthful", "refined"],
        "weight": 1.3
    },
    "American Beauty": {
        "prompt": "Small compact softly oval face with distinctly youthful late-teen proportions, softly rounded upper cheeks, fuller natural cheek volume, a short soft mid-face with a reduced vertical distance from the eyes to the chin, slim lower face, smooth gently tapered jawline ending in a small softly rounded chin, natural Caucasian-American facial characteristics with balanced understated proportions, large expressive almond-shaped to softly rounded eyes with youthful openness, naturally defined upper lashes, softly straight medium-dark eyebrows with a gentle low arch and naturally tapered ends, small refined Caucasian nose with a narrow-to-medium straight bridge, neat nostrils, softly defined nasal tip and natural subtle projection, naturally full rose-colored lips with a clearly defined Cupid's bow, slightly fuller lower lip, soft relaxed mouth, balanced near-symmetrical facial proportions, delicate features, gentle transitions between forehead, cheeks, nose, jaw and chin, youthful naturally realistic facial structure with understated realistic beauty, Euro-American Western facial structure, softly balanced face width with a gently widened mid-face, full rounded cheek volume, subtle softly blending cheekbones, softly curved facial contours, compact short face length, small narrow moderately projecting nose, rounded soft chin, proportionally natural eye size, clean bare-faced natural look, subtle natural facial modeling, realistic skin texture with visible fine pores and natural detail.",
    ...
    "K-Idol Soft": {
        "prompt": "Korean idol beauty with a compact softly oval face, fuller rounded cheek volume, softly straight dark brows, gentle monolid or softly creased eyes, gradient soft pink lips, delicate small nose, glass skin finish with subtle dewy highlighter, clean youthful features, elegant natural minimal makeup.",
        "description": "K-idol look with porcelain glass skin and gradient lips",
        "tags": ["k-beauty", "idol", "porcelain", "glass skin", "soft"],
        "weight": 1.2
    },
    "Editorial High Fashion": {
        "prompt": "High fashion editorial face, softly sculpted cheekbones, gently defined jawline, bold groomed eyebrows, softly shadowed expressive eyes, matte flawless complexion, refined elegant features, harmonious compact proportions, couture runway beauty, confident closed-lip expression, refined editorial makeup.",
        "description": "Runway editorial beauty with softly sculpted features",
...
_FACE_PRESETS.update({
    "Girl Next Door": {
        "prompt": "Fresh natural girl next door beauty with a compact softly oval face and full soft cheeks, light freckles across the nose, rosy cheeks, soft natural brows, subtle glossy pink lips, minimal clean makeup, approachable friendly expression, healthy realistic skin texture.",
        "description": "Fresh approachable beauty with light freckles",
        "tags": ["natural", "freckles", "fresh", "girl next door", "approachable"],
        "weight": 1.2
    },
    "Hollywood Classic": {
        "prompt": "Classic Hollywood cinematic beauty, elegantly arched defined eyebrows, deep expressive eyes with soft lashes, softly sculpted cheekbones, glossy deep red lips, smooth luminous complexion, compact balanced facial proportions, glamorous timeless features, polished silver-screen elegance, refined vintage glamour.",
        "description": "Timeless silver-screen glamour with red lips",
        "tags": ["hollywood", "classic", "glamour", "red lips", "cinematic"],
        "weight": 1.1
    },
    "Ethereal Elf": {
        "prompt": "Ethereal elven beauty with a compact softly oval face and soft rounded cheek volume, subtly pointed graceful ears, large luminous eyes, softly feathered brows, delicate slender nose, soft petal lips, otherworldly serene expression, gentle fairy-like glow with faint luminous shimmer.",
        "description": "Otherworldly elven beauty with luminous glow",
        "tags": ["ethereal", "elf", "fantasy", "luminous", "delicate"],
        "weight": 1.0
    },
    "Nordic Cool": {
        "prompt": "Nordic Scandinavian beauty with a compact softly oval face, softly high rounded cheekbones, light ash-blonde eyebrows, narrow straight nose, subtle natural rose lips, calm cool expression, fresh clean minimal makeup, wintery pale elegance.",
        "description": "Nordic cool beauty with delicate pale features",
        "tags": ["nordic", "cool", "scandinavian", "pale", "elegant"],
        "weight": 1.1
    },
    "Mediterranean Warm": {
        "prompt": "Mediterranean beauty, deep-set expressive eyes, softly defined dark eyebrows, gently straight nose, full glossy lips with warm rose tone, softly defined cheekbones, full softly rounded cheeks, lively warm expression.",
    ...
    "East Asian Delicate": {
        "prompt": "Refined East Asian beauty with a delicate compact oval face and soft cheek fullness, softly almond-shaped eyes with subtle eyeliner, gently arched thin brows, small refined nose, softly tinted lips, smooth radiant complexion, elegant minimal makeup, graceful delicate features.",
    ...
    "Afrocentric Radiance": {
        "prompt": "Radiant Afrocentric beauty, striking wide-set expressive eyes, full softly arched eyebrows, softly high elegant cheekbones, full softly rounded cheeks, beautifully full lips, softly defined nose with a softly rounded tip, vibrant confident features, healthy glowing skin with natural texture.",
        "description": "Radiant beauty with full lips and softly defined cheekbones",
        "tags": ["afrocentric", "radiant", "full lips", "glowing", "confident"],
        "weight": 1.1
    },
    "South Asian Grace": {
        "prompt": "Graceful South Asian beauty, large expressive almond eyes with long lashes, softly sculpted eyebrows, softly defined cheekbones, full softly rounded cheeks, elegant straight nose, full natural lips with warm rose tone, refined classic features, elegant graceful expression.",
    ...
    "Latina Spark": {
        "prompt": "Vibrant Latina beauty, large expressive eyes, softly arched defined brows, softly prominent natural cheekbones, full youthful cheeks, full glossy lips, softly rounded nose, lively confident expression, energetic warm beauty.",
        "description": "Vibrant beauty with full lips and softly defined cheekbones",
        "tags": ["latina", "vivacious", "full lips", "cheekbones", "confident"],
        "weight": 1.1
    },
    "Gothic Porcelain": {
        "prompt": "Gothic porcelain beauty, softly expressive eyes with heavy natural lashes, dark arched brows, delicate straight nose, deep plum or black lips, soft contrasting pale features, compact softly rounded facial contours, moody elegant alternative beauty.",
        "description": "Gothic beauty with dark lips and softly expressive eyes",
        "tags": ["gothic", "pale", "porcelain", "dark lips", "alternative"],
        "weight": 1.0
    },
    "Freckled Fresh": {
        "prompt": "Fresh freckled beauty with soft rounded youthful cheeks, a warm scattering of freckles across the nose and cheeks, soft light brows, natural pink lips, healthy outdoor glow, natural bare skin texture, youthful lively expression.",
    ...
    "Athlete Sun-Kissed": {
        "prompt": "Athletic sun-kissed beauty, healthy natural texture, bright clear eyes, straight clean eyebrows, softly defined jawline, softly rounded youthful cheeks, softly balanced features, small natural athletic nose, neutral relaxed mouth, clean fresh-faced look, energetic healthy appearance.",
